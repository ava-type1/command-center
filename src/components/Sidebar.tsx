import { LayoutDashboard, Lightbulb, DollarSign, PenTool, Calendar, X, Zap, Target } from 'lucide-react';

export type View = 'dashboard' | 'finance' | 'content' | 'ideas' | 'briefing' | 'prospects';
